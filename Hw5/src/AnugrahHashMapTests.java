...
public class AnugrahHashMapTests {
    ...
    @Test ()
    public void testAddProbingInfiniteLoop() {
        // setup
        assertNull(map.add(1, "a")); // 1
        assertNull(map.add(12, "b")); // 2
        assertNull(map.add(23, "c")); // 5
        assertNull(map.add(34, "d")); // 10
        assertNull(map.add(45, "e")); // 6
        assertNull(map.add(56, "f")); // 4

        // check size
        assertEquals((Object) 6, map.size());
        ...
        expected[5] = new MapEntry<>(23, "c");
        expected[10] = new MapEntry<>(34, "d");
        expected[6] = new MapEntry<>(45, "e");
        expected[4] = new MapEntry<>(56, "f");
        assertArrayEquals(expected, map.toArray());


        // Quadratic Probing Iterations
        // 1st element - 1 : 1 iteration
        // 2nd element - 1 => 2 : 2 iterations
        // 3rd element - 1 => 2 => 5 : 3 iterations
        // 4th element - 1 => 2 => 5 => 10 : 4 iterations
        // 5th element - 1 => 2 => 5 => 10 => 6 : 5 iterations
        // 6th element - 1 => 2 => 5 => 10 => 6 => 4 : 6 iterations
        // 7th element - 1 => 2 => 5 => 10 => 6 => 4 =>4 => 6 => 10 => 5 => 2 : More than 11 iterations
        // Hence must resize

        // good test case, something that finds an index at the 11th offset

        // add 7th element
        assertNull(map.add(67, "g"));

        // check size
        assertEquals((Object) 7, map.size());

        // check structure
        MapEntry<Integer, String>[] expected2 = new MapEntry[23];
        expected2[1] = new MapEntry<>(1, "a");
        expected2[12] = new MapEntry<>(12, "b");
        expected2[0] = new MapEntry<>(23, "c");
        expected2[11] = new MapEntry<>(34, "d");
        expected2[22] = new MapEntry<>(45, "e");
        expected2[10] = new MapEntry<>(56, "f");
        expected2[21] = new MapEntry<>(67, "g");
        assertArrayEquals(expected2, map.toArray());
    }
